-- [[ UNIVERSAL HUB - PC & MOBILE ULTIMATE ]]
...
-- Change to game:GetService("CoreGui") for Executors
local ParentUI = Player:WaitForChild("PlayerGui") 

-- 1. Cleanup
if ParentUI:FindFirstChild("SarveshHub_Ultimate") then ParentUI:FindFirstChild("SarveshHub_Ultimate"):Destroy() end
...
print("Ultimate Premium Hub Loaded Successfully")
